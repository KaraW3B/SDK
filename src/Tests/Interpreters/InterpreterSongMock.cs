...
{
    internal sealed class InterpreterSongMock : IInterpretableSong
    {
        ...
        public List<SongAlertDto> Alerts { get; } = new();
        ...
        {
            Alerts.Add(new SongAlertDto { Type = type, Level = level, Message = message, FileLine = fileLine });
        }
