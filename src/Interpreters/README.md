...
The KaraW3B.SDK.Interpreters provide parsers and writers for every UltraStar song text file formats respecting format conventions from [UltraStar format rules](https://github.com/UltraStar-Deluxe/format)
